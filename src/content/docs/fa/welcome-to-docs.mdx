...
<CardGrid stagger>
  ...
  <Card title="ابزارها و تجهیزات" icon="seti:eslint">
    تمامی ابزارها و تجهیزات با کیفیت برتر شرکت AutoLifeTech را کشف کنید. هر بخش شامل مشخصات دقیق، راهنمای استفاده و نکات نگهداری است.
  </Card>
